...
int main(void)
{
  ...
  HIDInterfaceMatcher matcher = { 0x20CE, 0x0022, NULL, NULL, 0 };
   ...
   */
/*
        unsigned char   PATHLEN = 8;
        int const               PATH_IN[] = { 0xffa00001, 0xffa00001 };
        int const               PATH_OUT[] = { 0xffa00001, 0xffa00001 };

        unsigned char   SEND_PACKET_LEN = 64;
        unsigned char   RECV_PACKET_LEN = 64;
