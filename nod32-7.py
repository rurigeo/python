...
theurl = 'http://download.eset.com/download/engine/eav/offline_update_eav.zip'
# if you want to run this example you'll need to supply
# a protected page with your username and password

username = user
password = passwd            # a very bad password
...
try:
    ...
    sys.exit(1)
thepage = handle.read()
with open('D:\\home\\site\\wwwroot\\offline_update_eav.zip','wb') as dat:
    dat.write(zip.read())
